...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash("Your has been created, you can login, Congrats %s" % form.username.data, 'success')
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with intstructions to reset your password', 'info')
        return redirect (url_for('users.login'))
